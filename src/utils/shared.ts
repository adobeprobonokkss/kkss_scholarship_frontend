...
import { userSession, SESSION_STORAGE_USERS_KEY, defaultUserSession } from "./../interface/UserSession";
...
export const setUserInfo = (userDetails: object) => {
  sessionStorage.setItem(SESSION_STORAGE_USERS_KEY, JSON.stringify(userDetails));
};
