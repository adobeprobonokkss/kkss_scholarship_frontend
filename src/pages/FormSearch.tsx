...
import { formatDate, scholarshipApplicationStatuses } from "../utils/shared";
...
const FormSearch: React.FC = () => {
  ...
  const fetchScholarshipApplications = async () => {
    console.log("fetchScholarshipApplications");
                ...
                searchResults.map(
                  (searchResult: ScholarshipData & ResultType) => (
                    <TableRow>
                      ...
                      <TableCell>
                        {searchResult.submissionDate?.seconds
                          ? formatDate(
                              new Date(+searchResult.submissionDate?.seconds)
                            )
                          : "N/A"}
                      </TableCell>
                    </TableRow>
